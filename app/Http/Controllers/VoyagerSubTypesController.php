...
class VoyagerSubTypesController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        AccountSubtype::where('id', $id)->update(['default_inputs' => $default_inputs]);
    ...
    public function store(Request $request)
    {
       ...
       // When add new subitem
        ...
        $default_inputs = json_encode($default_inputs);
        AccountSubtype::where('id', $data->id)->update(['default_inputs' => $default_inputs]);
...
//       dd($menuItems);
        foreach ($menuItems as $index => $menuItem) {
            $item = AccountSubtype::findOrFail($menuItem->id);
            $item->order = $index + 1;
